...
const AdminCard = () => {
  const [cards, setCards] = useState([
    { id: 1, title: 'Card 1', details: 'Details 1', imageUrl: 'https://res.cloudinary.com/dunzdwo0h/image/upload/v1708701387/donuts_btytr6.jpg' },
    { id: 2, title: 'Card 2', details: 'Details 2', imageUrl: 'https://res.cloudinary.com/dunzdwo0h/image/upload/v1708701392/brownies_ttuury.jpg' },
    { id: 3, title: 'Card 3', details: 'Details 3', imageUrl: 'https://res.cloudinary.com/dunzdwo0h/image/upload/v1708701386/cupcake1_inzg70.jpg' },
  ]);
